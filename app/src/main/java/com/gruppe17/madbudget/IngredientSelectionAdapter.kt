...
class IngredientSelectionAdapter(var myDataset: ArrayList<IngredientSelectionWithIngredients>,
                                 ...
                                 var ingredientCheckBoxClickListener: OnIngredientCheckBoxClickListener) : RecyclerView.Adapter<IngredientSelectionAdapter.IngredientViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): IngredientViewHolder {
        ...
        return IngredientViewHolder(itemView, ingredientSelectionClickListener, ingredientCheckBoxClickListener)
    }
    ...
    class IngredientViewHolder(itemView: View, ingredientSelectionClickListener: OnIngredientSelectionClickListener, ingredientCheckBoxClickListener: OnIngredientCheckBoxClickListener) : RecyclerView.ViewHolder(itemView) {
